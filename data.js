...
// ---- Word glossary for tap-to-translate in conversations ----
// Keys are lowercase words as they appear. Elided forms end in an apostrophe (dov' = dove).
const GLOSSARY = {
  "a": "to / at",
  "abbiamo": "we have (avere)",
  "acqua": "water",
  "al": "to the / at the (a + il)",
  "alla": "to the / at the (a + la)",
  "alle": "at the (time) (a + le)",
  "allergico": "allergic (m.); allergica (f.)",
  "allora": "so / well then",
  "altro": "other / another",
  "anche": "also / too",
  "aperol": "Aperol (the orange aperitif)",
  "arrivederci": "goodbye (polite)",
  "arrivo": "I'm coming (arrivare)",
  "autobus": "bus",
  "avete": "you (plural) have (avere)",
  "bagno": "bathroom",
  "banco": "counter / bar",
  "basilico": "basil",
  ...
  "bere": "to drink",
  "biglietti": "tickets (biglietto)",
  "birra": "beer",
  "bottiglia": "bottle",
  "buona": "good (f.)",
  "buonasera": "good evening",
  "buongiorno": "good morning / good day",
  "buonissimo": "delicious / really good",
  "caffè": "coffee (= espresso)",
  "campari": "Campari (the red bitter)",
  "capito": "understood (capire)",
  "cappuccino": "cappuccino",
  "carbonara": "carbonara (pasta with egg, guanciale, pecorino)",
  "carta": "card",
  "casa": "house; 'della casa' = the house (wine)",
  "cassa": "till / checkout",
  "certo": "of course / sure",
  "chi": "who",
  "ci": "there / us; 'ci sono' = there are",
  "cinquanta": "fifty",
  "cinque": "five",
  "come": "how / as",
  "compressa": "tablet / pill",
  "con": "with",
  "consiglia": "you recommend (consigliare, polite)",
  "contanti": "cash",
  "conto": "bill",
  "contorno": "side dish",
  "cornetto": "croissant",
  "cosa": "what / thing",
  "costa": "it costs (costare)",
  "così": "like this / so; 'basta così' = that's all",
  "crema": "cream / custard",
  "crudo": "raw / cured (prosciutto crudo)",
  "d'": "of (di, before a vowel)",
  "da": "from / for / to; 'da bere' = to drink",
  "dell'": "of the (di + l')",
  "della": "of the (di + la)",
  "destra": "right (direction)",
  "di": "of",
  "dica": "tell me / go ahead (dire, polite)",
  "dispiace": "'mi dispiace' = I'm sorry",
  "dividere": "to share / to divide",
  "dividiamo": "we share (dividere)",
  "do": "I give (dare)",
  "dov'": "where (dove, before è)",
  "dritto": "straight",
  "due": "two",
  "e": "and",
  "ecco": "here is / here you go",
  "era": "it was (essere)",
  "etti": "hectograms, 100 g units (etto)",
  "euro": "euro(s)",
  "favore": "'per favore' = please",
  "febbre": "fever",
  "fondo": "'in fondo' = at the back / end",
  "frizzante": "sparkling",
  "giornata": "day; 'buona giornata' = have a good day",
  "gli": "the (m. plural, before vowel/gn/s+cons.)",
  "gnocchi": "gnocchi (potato dumplings)",
  "grazie": "thank you",
  "ha": "you have (avere, polite) / he-she has",
  "ho": "I have (avere)",
  "i": "the (m. plural)",
  "il": "the (m.)",
  "in": "in",
  ...
  "insieme": "together",
  "la": "the (f.)",
  "le": "the (f. plural); also 'to you' (polite)",
  "lei": "you (polite) / she / her",
  "lentamente": "slowly",
  "litro": "litre",
  "lo": "it / the (m., before s+cons., z)",
  "lontano": "far",
  "lui": "he / him",
  "mal": "'mal di' = ache, pain in",
  "mangiare": "to eat",
  ...
  "mista": "mixed (f.)",
  "molto": "very / a lot",
  "naturale": "still (water) / natural",
  "nessun": "no / not any; 'nessun problema' = no problem",
  "no": "no",
  "noci": "walnuts / nuts",
  "non": "not",
  "novanta": "ninety",
  ...
  "ogni": "every",
  "ordinare": "to order",
  "ore": "hours; 'ogni otto ore' = every 8 hours",
  "otto": "eight",
  "pagare": "to pay",
  "pago": "I pay (pagare)",
  "pane": "bread",
  ...
  "poi": "then",
  "pomodoro": "tomato",
  "porto": "I bring (portare)",
  "possibile": "possible",
  "posso": "I can (potere)",
  "prego": "please / you're welcome / go ahead",
  "prendete": "you (plural) take / have (prendere)",
  "prenotato": "booked / reserved (prenotare)",
  "problema": "problem",
  "pronti": "ready (plural)",
  "prosciutto": "ham (crudo = cured, cotto = cooked)",
  "prossimo": "next",
  "può": "you can (potere, polite) / he-she can",
  "qualcos'": "something (qualcosa, before altro)",
  "qualcosa": "something",
  "quant'": "how much (quanto, before è)",
  "quanti": "how many",
  "quanto": "how much",
  "quattro": "four",
  "questo": "this",
  "qui": "here",
  "ragazzi": "kids / guys / young people",
  "ragù": "meat sauce",
  "ripetere": "to repeat",
  "rosso": "red",
  "scontrino": "receipt",
  ...
  "se": "if",
  "secondo": "main course / second",
  "seguitemi": "follow me (plural)",
  "semaforo": "traffic lights",
  "semplice": "plain / simple",
  "sempre": "always; 'sempre dritto' = straight ahead",
  "sento": "I feel (sentirsi); 'non mi sento bene' = I don't feel well",
  "senza": "without",
  "serata": "evening; 'buona serata' = have a good evening",
  "siamo": "we are (essere)",
  "siete": "you (plural) are (essere)",
  "sinistra": "left (direction)",
  "solo": "only / just",
  "sono": "I am / they are (essere)",
  "spritz": "spritz (prosecco + aperitif + soda)",
  "stazione": "station",
  "subito": "right away",
  "sì": "yes",
  "tavolo": "table",
  "testa": "head; 'mal di testa' = headache",
  "tocca": "'tocca a me' = it's my turn",
  "tre": "three",
  "tutti": "everyone / all (plural)",
  "tutto": "everything / all",
  "un": "a / an (m.)",
  "un'": "a / an (f., before vowel)",
  "una": "a / an (f.)",
  "uno": "one / a",
  "va": "it goes (andare); 'va bene' = OK",
  "venti": "twenty",
  "vi": "you (plural, object); 'vi porto' = I'll bring you",
  "vino": "wine",
  "voi": "you (plural)",
  "è": "is (essere)",
};
...
const AUDIO_EXTRA = [
  ...
  ...Object.keys(GLOSSARY).filter((w) => !w.endsWith("'")), // single words for the tap-a-word popover
];
